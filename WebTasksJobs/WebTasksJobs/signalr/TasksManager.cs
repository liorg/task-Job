...
//        private readonly static Lazy<TasksManager> _instance = new Lazy<TasksManager>(() =>
//            new TasksManager(GlobalHost.ConnectionManager.GetHubContext<TasksEmailLongRunning>().Clients));
